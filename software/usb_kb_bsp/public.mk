...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../pls.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80010c8
SOPC_SYSID_FLAG += --sidp=0x80010c8
ELF_PATCH_FLAG  += --sidp 0x80010c8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1556463430
SOPC_SYSID_FLAG += --timestamp=1556463430
ELF_PATCH_FLAG  += --timestamp 1556463430
